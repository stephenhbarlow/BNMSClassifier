...
from models.hf_model import HFBertModel
...
def parse_args():
    ...
    # data input settings
    parser.add_argument('--train_data_dir', type=str, default='data/tnm_train2.csv',
                        help='the path to the directory containing the training data.')
    parser.add_argument('--val_data_dir', type=str, default='data/tnm_val2.csv',
    ...
    parser.add_argument('--model_config', type=str, default="bert-large-cased",
                        help='the pretrained Transformer.') 
    ...
    parser.add_argument('--epochs', type=int, default=7, help='the number of training epochs.')
    ...
    # Optimization
    parser.add_argument('--lr', type=float, default=2e-5, help='the starting learning rate.')
...
def main():
    ...
    # create data loader
    train_dataloader = BertDataLoader(args, split='train', shuffle=True)
